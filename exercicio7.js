...
//Using currying and composition create a specialized function that always acts 
// on the users array but allows you to enter a user name. Have it  return a clone of that user.

const getUseruser = pipe(
    curry(getUser(users)("Henry")),
    cloneObj,
...
// (Only invoked if you want to update Henry). It should accepts 
// a new score and then return a new array that contains the updated score and tries. 
// To compose this function you may need to create other functions.
